...
\end{equation}
Equivalently, conformance holds exactly when all four difference sets are empty. Outside incidence and absent mapped identities are reported separately and do not alter that result.
...
\bibitem{artifact}
G. Dolbear, ``TIDE exact-relationship conformance and question-audit artifact,'' 2026. [Online]. Available: \url{https://github.com/tnkinobirb/TIDE-Model-Artifact/commit/b59d80f6f4454b55332a64dfc6bd5bc7f2366a63}
